...
<head> 
  ...
  <title>SISTEM MONITORING KEBUN SAWIT</title>
...
<body class="hold-transition login-page" style="background: url('<?=base_url('assets/gambar/bg.jpg')?>');
...
<div class="login-box">
  ...
  <p class="footer" align="center">SISTEM MONITORING KEBUN SAWIT</p>
  <!-- /.login-box-body -->
</div>
<!-- /.login-box -->
